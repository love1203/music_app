...
setCrea() {
    ...
    getDetail() {
        let res = API.recommendsongs()
            .then(res => {
                if (res.code == 200) {
                    console.log(res)
                    this.setState({
                        detail: res.recommend,
                        imgUrl: res.recommend[0].album
                    })
                }
            })
    }
    ...
    render() {
        return <View style={{ flex: 1, backgroundColor: '#fff' }}>
                ...
                <View style={{ height: 250, overflow: 'hidden' }}>
                    ...
                    <View style={{ width: 90, height: 90, position: 'relative' }}>
                        ...
                        <View style={{ flex: 1, marginLeft: 14 }}>
                            <Text style={{ color: '#fff', fontSize: 16, fontWeight: '700' }}>每日推荐</Text>
            ...
            <View style={{ position: 'absolute', height: 70, top: 0, width: '100%', flexWrap: 'wrap', flexDirection: 'row', padding: 14 }}>
                ...
                <Text style={{ lineHeight: 50, color: '#fff', fontSize: 16, fontWeight: '700', marginLeft: 10 }}>每日推荐</Text>
            </View>
